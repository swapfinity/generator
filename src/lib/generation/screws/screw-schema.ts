...
const screwType = z.enum(["FLAT_HEAD", "ROUND_HEAD", "PAN_HEAD"]).default("PAN_HEAD").describe("The type of the screw.").meta({ viewName: "Screw Type", rowWeight: 1, rowName: "screwType" })
